...
| **F7** | Assistive framing: flags-for-review, confidence shown, reasoning visible, never auto-approve/reject | INT:Dave (judgment, don't make life harder) | MatchEngine output, Report UI | 3.3–3.10, 4.5 | TC-01, TC-09 | **Tested** (engine; UI pending) |
